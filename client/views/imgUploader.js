...
Template.imgUploader.events({
	'click #addCandidatePhotoDropzone':function(e){
		preventAndStop(e);
	...
	'dragenter #addCandidatePhotoDropzone':function(e){
		preventAndStop(e);
		Template.instance().isDragEnter.set(true);
	},
	'dragover #addCandidatePhotoDropzone':function(e){
		preventAndStop(e);
	},
	'dragleave #addCandidatePhotoDropzone':function(){
		Template.instance().isDragEnter.set(false);
	},
	'drop #addCandidatePhotoDropzone':function(e){
		preventAndStop(e);
